      ...
      <div className="contact-container">
        ...
        {liked && (
          <p className="greeting-message">
            ...
            "ᴵ ˢⁱⁿᶜᵉʳᵉˡʸ ᵃᵖᵖʳᵉᶜⁱᵏᵉ ʸᵒᵘ ᵗᵃᵏⁱⁿᵍ ᵗʰᵉ ᵗⁱᵐᵉ ᵗᵒ ᵉˣᵖˡᵒʳᵉ ᵐʸ ᵖᵒʳᵗᶠᵒˡⁱᵒ. ʸᵒᵘʳ ᵃᵗᵗᵉⁿᵗⁱᵒⁿ ᵐᵉᵃⁿˢ ᵃ ˡᵒᵗ, ᵃⁿᵈ ᴵ ˡᵒᵒᵏ ᶠᵒʳʷᵃʳᵈ ᵗᵒ ᵃⁿʸ ⁱⁿˢⁱᵍʰᵗˢ ᵒʳ ᵒᵖᵖᵒʳᵗᵘⁿⁱᵗⁱᵉˢ ᵗʰᵃᵗ ᵐᵃʸ ᵃʳⁱˢᵉ ᶠʳᵒᵐ ʸᵒᵘʳ ʳᵉᵛⁱᵉʷ." <br /> - ᵣₐₘₑₛₕwₐᵣ ₙₐᵥₐₜₕₐᵣ
          </p>
        )}
      </div>
